...
func routes(a *App) http.Handler {
	...
	registerProtected(mux, a, a.AdminEmail, "/admin/email")
	registerProtected(mux, a, a.AdminSaveEmail, "/admin/email/save")
	registerProtected(mux, a, a.AdminTestEmail, "/admin/email/test")
